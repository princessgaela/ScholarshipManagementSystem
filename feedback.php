...
function get_all_records()
{
  ...
  if (mysqli_num_rows($result) > 0) {
    ...
    $Sql = "SELECT * FROM feedbacks WHERE academicyear = '$year' AND semester LIKE '$semester'";
  $result = mysqli_query($con, $Sql);
  if (mysqli_num_rows($result) > 0) {
...
"></a>
  ...
  <div class="container-fluid" style="padding-top: 50px;">
    <div class="row">
      ...
      <div class="col-sm-10">
        <div class="container-fluid">
          <form style="background:#f1f1f1;" class="form-horizontal" action="feedback.php" method="post" name="upload_excel" enctype="multipart/form-data">
            <fieldset>
              <!-- Form Name -->
