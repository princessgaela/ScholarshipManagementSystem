...
if (isset($_POST['insertdata'])) {
    ...
    $description = mysqli_real_escape_string($connection, "Added an Announcement about " . $subject . "");
    $author = $_SESSION['NAME'];

    $query = "INSERT INTO announcements (`subject`,`announcement`,`academicyear`,`semester`) VALUES ('$subject','$announcement','$year','$semester')";
    $query_run = mysqli_query($connection, $query);
    ...
    if ($query_run) {
        ...
        echo '<script> alert("Announcement Not Posted"); </script>';
    }
}
?>
...
if (isset($_POST['updatedata'])) {
    ...
    $description = mysqli_real_escape_string($connection, "Updated an Announcement about " . $subject . "");
    $author = $_SESSION['NAME'];

    $query = "UPDATE announcements SET subject='$subject', announcement='$message' WHERE id='$id'  ";
    $query_run = mysqli_query($connection, $query);
    ...
    if ($query_run) {
        ...
        echo '<script> alert("Announcement Not Updated"); </script>';
    }
}
?>
...
if (isset($_POST['deletedata'])) {
    $id = $_POST['delete_id'];
    $subject = mysqli_real_escape_string($connection, $_POST['subject']);
    $description = mysqli_real_escape_string($connection, "Deleted an Announcement about " . $subject . "");
    $author = $_SESSION['NAME'];
    ...
    if ($query_run) {
        ...
        echo '<script> alert("Announcement Not Deleted"); </script>';
    }
}
...
function get_all_records()
{
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        $year = $row['year'];
        $semester = $row['semester'];
        $Sql = "SELECT * FROM announcements WHERE academicyear = '$year' AND semester LIKE '$semester'";
    $result = mysqli_query($con, $Sql);
    if (mysqli_num_rows($result) > 0) {
    ...
    <div class="container-fluid" style="padding-top: 50px;">
        <div class="row">
          <div class="col-sm-2 sidenav">
            ...
            <a href="announcement.php"  class="active"  ><i class="bi bi-megaphone"></i> Announcement</a>
            ...
            <div class="modal-content">
                <form action="announcement.php" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label> Subject </label>
                            <input required type="text" name="subject" class="form-control" placeholder="Subject" onkeydown="return alphaOnly(event);">
                        </div>

                        <div class="form-group">
                            <label> Announcement </label>
                            <textarea required name="announcement" class="form-control" cols="30" rows="10"></textarea>
                        </div>
                    </div>
            </div>
            <div class="modal-footer">
            ...
            <div class="modal-content">
                ...
                <form action="announcement.php" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label> Subject </label>
                            <input required type="text" name="subject" id="subject" class="form-control" placeholder="Subject" onkeydown="return alphaOnly(event);">
                        </div>

                        <div class="form-group">
                            <label> Message </label>
                            <textarea required name="announcement" class="form-control" id="announcement" cols="30" rows="10"></textarea>
