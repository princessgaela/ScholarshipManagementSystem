...
if (isset($_POST['insertdata'])) {
  ...
  $username = $studentno;
  $password = $studentno;
  $description = $username . " student account has been created";
  $author = $_SESSION['NAME'];


  $query = "INSERT INTO users (`username`,`password`,`studentno`,`name`,`role`) VALUES ('$username','$password','$studentno',UPPER('$name'),UPPER('$role'))";
  $query_run = mysqli_query($connection, $query);
...
if (isset($_POST['updatedata'])) {
  ...
  $description = $username . " student account has been updated";
  $author = $_SESSION['NAME'];

  $query = "UPDATE users SET username='$username', studentno=UPPER('$studentno'), name=UPPER('$name') WHERE id='$id'  ";
  $query_run = mysqli_query($connection, $query);
...
if (isset($_POST['deletedata'])) {
  ...
  $description = $username . " student account has been deleted";
  $author = $_SESSION['NAME'];
...
function get_all_records()
{
  ...
  $dbname   = "dbscholarship";
  $con = new mysqli($hostname, $username, $password, $dbname);
  $Sql = "SELECT * FROM users WHERE role LIKE 'STUDENT'";
...
<head>
  <title>User Accounts - Student</title>
  <meta charset="utf-8">
    ...
    <div class="row">
      <div class="col-sm-2 sidenav">
        ...
        <div class="dropdown-container">
          <a href="useraccount.php" class="active" ><i class="bi bi-mortarboard"></i> Student</a>
      ...
      <div class="col-sm-10">
        <div class="container-fluid">
          <form style="background:#f1f1f1;" class="form-horizontal" action="useraccount.php" method="post" name="upload_excel" enctype="multipart/form-data">
            <fieldset>
              <!-- Form Name -->
              <legend>User Accounts - Student</legend>
              <!-- File Button -->
      ...
      <div class="modal-content">
        ...
        <form action="useraccount.php" method="POST">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              <label> Student No. </label>
              <input required type="text" name="studentno" id="ustudentno" class="form-control" placeholder="Student No." onkeydown="return numbersOnly(event);">
            </div>
